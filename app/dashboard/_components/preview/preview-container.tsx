...
const PreviewContainer = () => {
  ...
  if (destopOrTab) {
    return (
      <div className="fixed md:mt-12 lg:mt-8 max-w-80 lg:max-w-[520px] md:max-w-72 w-full right-0 top-0 bottom-0 z-0 h-full p-8 hidden md:grid place-items-center border-l border-gray-200">
